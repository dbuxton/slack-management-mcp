...
To invite someone to a channel, **the bot itself must be a member of that
...
If the bot is not a member and cannot join, `invite_user_to_channel` returns a
clear error explaining what to do.
